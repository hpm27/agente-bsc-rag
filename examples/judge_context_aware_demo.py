...
def demo_comparison():
    ...
    print("\n[CONTEXTO: DIAGNOSTIC]")
    print(
        f"  Score: {judgment_diagnostic.quality_score:.2f} | Verdict: {judgment_diagnostic.verdict}"
    )
    ...
    print("\n[COMPARAÇÃO]")
    print(
        f"  Diferença de score: {judgment_diagnostic.quality_score - judgment_rag.quality_score:.2f}"
    )
    print("  Context='DIAGNOSTIC' -> Foco em qualidade da análise")
    print("  Context='RAG' -> Penaliza falta de fontes")
