...
**Positivas**:
- [OK] MVP 27% mais rápido (4-5 semanas vs 5-6)
- [OK] Especialização profunda (autoridade em BSC)
- [OK] Validação focada (menos variáveis)
- [OK] Feedback claro ("O que falta no agente BSC?")

**Negativas**:
- [ERRO] Target market limitado (apenas empresas BSC)
- [ERRO] Competidores generalistas podem parecer "mais completos"
