...
def sample_diagnostic():
    ...
    recommendations = [
        ...
        Recommendation(
            ...
            timeframe="6-9 meses",
            next_steps=[
                "Mapear processos candidatos",
                "Selecionar ferramenta RPA",
                "Pilotar em 2 processos",
            ],
            quick_win=False,
...
def test_rendered_html_contains_executive_summary(
    template_manager, sample_diagnostic, sample_profile
):
...
def test_render_perspective_invalid_raises_error(
    template_manager, sample_diagnostic, sample_profile
):
