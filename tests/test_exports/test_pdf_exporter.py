...
def test_export_full_diagnostic_generates_pdf_file(
    pdf_exporter, complete_diagnostic, sample_profile
):
...
def test_export_full_diagnostic_uses_custom_output_path(
    pdf_exporter, complete_diagnostic, sample_profile, tmp_path
):
...
def test_export_invalid_perspective_raises_error(pdf_exporter, complete_diagnostic, sample_profile):
    ...
    with pytest.raises(ValueError, match="Perspectiva inválida"):
        pdf_exporter.export_perspective(complete_diagnostic, sample_profile, perspective="Invalid")
