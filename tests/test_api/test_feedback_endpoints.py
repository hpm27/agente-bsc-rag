...
def mock_feedback_service():
    ...
    service.get_feedback_stats = Mock(return_value={
        "total_count": 10,
        "avg_rating": 4.2,
        "positive_count": 7,
        "negative_count": 1,
...
def test_get_feedback_returns_404_when_not_found(client, mock_api_key):
    ...
    with patch("api.routers.feedback.get_feedback_service", return_value=mock_service), \
