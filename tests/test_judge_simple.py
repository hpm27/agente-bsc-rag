...
def test_judge_context_aware_basic():
    ...
    print(f"[OK] DIAGNOSTIC: score={judgment_diagnostic.quality_score:.2f}, verdict={judgment_diagnostic.verdict}")
    ...
    print(f"[OK] DEFAULT: score={judgment_default.quality_score:.2f}, verdict={judgment_default.verdict}")
