        ...
        children=[
            ...
            IssueNode(
                ...
                children=[
                    IssueNode(
                        id="leaf_1_2_1",
                        text="Benchmarking insuficiente",
    ...
    return BenchmarkReport(
        ...
        metrics={
            "revenue_growth": {
                "company": 18.5,
                "industry_avg": 25.0,
                "industry_top_25": 35.0,
                "gap": -6.5,
            },
            "ebitda_margin": {
                "company": 15.0,
                "industry_avg": 22.0,
                "industry_top_25": 30.0,
                "gap": -7.0,
            },
...
def test_save_deletes_old_output_same_tool(mock_mem0_client, sample_swot_output):
    ...
    new_tool_output = ToolOutput(tool_name="SWOT", tool_output_data=sample_swot_output.model_dump())
...
def test_save_tool_output_empty_client_context(mock_mem0_client, sample_swot_output):
    ...
    tool_output = ToolOutput(
        tool_name="SWOT", tool_output_data=sample_swot_output.model_dump(), client_context=None
    )
...
def test_save_tool_output_with_connection_error(mock_mem0_client, sample_swot_output):
    ...
    # Criar ToolOutput
    tool_output = ToolOutput(tool_name="SWOT", tool_output_data=sample_swot_output.model_dump())
...
def test_save_and_get_five_whys_output(mock_mem0_client, sample_five_whys_output):
    ...
    # STEP 1: Salvar
    tool_output = ToolOutput(
        tool_name="FIVE_WHYS", tool_output_data=sample_five_whys_output.model_dump()
    )
