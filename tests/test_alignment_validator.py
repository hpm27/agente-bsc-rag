        ...
        financial=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="12 meses",
                    success_criteria=[
                        "Margem EBITDA atingir >= 18% até dez/2026",
                        "ROI atingir >= 20% sobre CAPEX",
                    ],
                    related_kpis=["Margem EBITDA %", "ROI %"],
                    priority="Alta",
                ),
                StrategicObjective(
                    ...
                    timeframe="6 meses",
                    success_criteria=[
                        "Custo por unidade reduzir -15% vs baseline",
        ...
        customer=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="12 meses",
                    success_criteria=[
                        "NPS atingir >= 50 pontos até dez/2026",
                        "Churn reduzir para < 5% ao ano",
                    ],
                ...
                StrategicObjective(
                    ...
                    timeframe="6 meses",
                    success_criteria=[
                        "OTIF atingir >= 95% até jun/2026",
                        "Lead time de cotação reduzir < 24h",
                    ],
        ...
        process=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="6 meses",
                    success_criteria=[
                        "Lead time reduzir para <= 31 dias até jun/2026",
                        "Implementar 10+ kaizens até Q2 2026",
                    ],
                ...
                StrategicObjective(
                    ...
                    timeframe="9 meses",
                    success_criteria=[
                        "OEE atingir >= 85% nas linhas críticas",
                        "Disponibilidade atingir >= 90% até set/2026",
                    ],
        ...
        learning=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="6 meses",
                    success_criteria=[
                        "80% da equipe certificada Green Belt até jun/2026",
                        "120h de treinamento Lean por pessoa/ano",
                    ],
                ...
                StrategicObjective(
                    ...
                    timeframe="12 meses",
                    success_criteria=[
                        "Gerar 50+ kaizens por ano até dez/2026",
                        "Atingir 70% de envolvimento da equipe no programa",
                    ],
        ...
        financial=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="12 meses",
                    success_criteria=[
                        "Critério de sucesso número um válido",
                        "Critério de sucesso número dois válido",
                    ],
        ...
        customer=StrategyMapPerspective(
            ...
            objectives=[
                StrategicObjective(
                    ...
                    timeframe="12 meses",
                    success_criteria=[
                        "Critério de sucesso válido número um",
                        "Critério de sucesso válido número dois",
                    ],
                    related_kpis=["KPI"],
                    priority="Alta",
                ),
...
def test_cause_effect_exists_fails_with_less_than_4_connections_DISABLED(
    alignment_validator, valid_strategy_map
):
