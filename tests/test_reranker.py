...
class TestFusionReranker:
    ...
    def test_fuse_multiple_lists(self, reranker):
        ...
        results = [
            ...
            [  # Lista 2
                {"id": "doc2", "content": "c2", "metadata": {}, "source": "test.pdf", "page": 2},  # Aparece em ambas
    ...
    def test_fuse_respects_top_n(self, reranker):
        ...
        results = [[
            {"id": f"doc{i}", "content": f"c{i}", "metadata": {}, "source": "test.pdf", "page": i}
            for i in range(20)
        ]]
...
class TestHybridReranker:
    ...
    def test_rerank_combines_methods(self, hybrid_reranker):
        ...
        vector_results = [
            {"id": "doc1", "content": "c1", "metadata": {}, "score": 0.9}
        ]
        text_results = [
            {"id": "doc2", "content": "c2", "metadata": {}, "score": 0.8}
        ]
