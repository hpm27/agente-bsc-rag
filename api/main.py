...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "clients", "description": "Operações com clientes BSC (CRUD completo)"},
        {"name": "diagnostics", "description": "Diagnósticos BSC multi-perspectiva"},
        {"name": "tools", "description": "Ferramentas consultivas (SWOT, Five Whys, KPI, etc)"},
        {"name": "reports", "description": "Exports PDF e CSV"},
        {"name": "webhooks", "description": "Notificações assíncronas e gerenciamento de webhooks"},
        {"name": "admin", "description": "Endpoints administrativos (API keys, metrics)"},
        {"name": "analytics", "description": "Analytics e métricas da API (FASE 4.4)"},
        {
            "name": "feedback",
