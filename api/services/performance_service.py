...
class PerformanceService:
        ...
        try:
            ...
            try:
                ...
                results = self.client.search(
                    query="endpoint method duration_ms status", filters=filters, limit=limit
                )
    ...
    def aggregate_stats(self, endpoint: str | None = None, hours: int = 24) -> dict[str, Any]:
...
def get_performance_service(mem0_client: MemoryClient | None = None) -> PerformanceService:
